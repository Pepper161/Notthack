...
class ApiService {
  static const String _overrideBaseUrl =
      String.fromEnvironment('NOURISHCHAIN_API_BASE_URL', defaultValue: '');
  ...
  // Every request that hits a protected endpoint funnels through these
  // header builders so the bearer token is attached automatically.
  ...
  // ─── Issuer ────────────────────────────────────────────────────────────────
  // NOTE: actorId is now derived server-side from the authenticated session,
  ...
  // ─── Merchant ──────────────────────────────────────────────────────────────
  // merchantId is NO LONGER a client-supplied parameter — the backend reads
  // it from the authenticated session. This is the core fix for the
  // "anyone can claim to be any merchant" loophole.
  ...
  // ─── Student ───────────────────────────────────────────────────────────────
  // Students can only look up their own voucher; the backend uses the
  // session's studentId regardless of what's in the URL, and rejects
  // cross-student requests.
