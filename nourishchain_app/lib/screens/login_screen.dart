...
/// Single entry point for every user.
///
/// After a successful login the bearer token is stored in [AuthService] and
/// the user is routed to the one screen that matches their role. There is no
/// manual "pick a role" step any more — the role is decided by the account.
